const ruminationDictionary = {
  ...
  "A HISTORY OF MY OBSESSIONS": {
    1: "During an interview for a position at a start-up, I was asked “whats makes you read for what a startup demands?” For me, starting something new and putting in the time that is required for incubating a new born idea is fueled by obsession. Obsession. An idea or thought that continually preoccupies or intrudes on a person's mind. For it is only in the obsessive mind does work becomes play, a necessity, the end-all-be-all, all at once.",
