const ruminationDictionary = {
  "ON FAILURE AND FEELING COOL": {
    1: "There is no reason for student clubs to be so damn competitive. Why are students my age, with similar life experiences, determining whether or not I get to be a part of their exclusive group? Who are they to decide? Here I am, a 1st year in college, fresh out of the hellish experience which was college admissions, doing another version of an admissions process—but it’s for student-led clubs. I go to a months worth of recruitment events for a club called TAMID, a premier consulting, fund and software development organization—hours and hours of listening to people lecture about their clubs, networking, doing panel interviews—and I get rejected. I feel my face getting heated whenever I see my interviewers around campus and avoid eye contact—but I know they don’t even recognize me.",
    2: "Embarrassment is so…embarrassing. I try to avoid getting embarrassed. But it’s so easy to find it in life: In class I run the risk of being cold called on, going out wearing a scarf for the first time, or walking down a set of stairs, I engage my core and think to myself “god I hope I don’t trip and roll my ankle” (I did that in front of the Snell Library stairs once, and had to sit down among the crowd due to the agonizing pain). Even writing things like this, and posting them for anyone to find, I can’t help but feel embarrassed. It’s weird, invasive, and at the core of it all, I feel so uncomfortable in my own skin. It’s a feeling I can’t purposefully shake off. I wait until I forget about the instance—and every once and awhile, the memory comes flooding back and I cringe. It’s like that mind game where you’re trying to avoid thinking about The Game itself, and every time you remember it, you lose.",
    3: "One rejection from a student club was enough for me. They didn’t want me and that was that. Back then, especially being new to college, it was imperative that I felt like I belonged in a space. And I certainly didn’t feel welcome in a community which rejected all my efforts. But I also knew better to put a student-led club on a pedestal. I had an inkling on where I fell short in my application, and wanted to put that lesson towards a second time, but boy was I scared; it was a second chance to get rejected and get embarrassed. I mustered up a YOLO mindset, and reapplied.",
    4: "My second time around, I got in (I later found out later that I barely got in, but who cares?). TAMID turned out to be one of the most pivotal, life-changing communities of my time at Northeastern. Their way of education, care, and due diligence towards building a truly tight-knit community was just the right mixture of chemistry to grow my own confidence in myself.",
    5: "I learned from that experience that confidence was my currency to handle failure and embarrassment. Before college, I think I was short on confidence change. Not because of anything in particular. It was just the result of being freshly hatched out of a turbulent, emo adolescence mind, and being unsure of who I really was. I’m thankful college was tender to me. TAMID became a confidence-making machine; people believed in me, I worked hard for them, and together, we achieved some beautiful goals.",
    6: "The height of my confidence-to-failure trading business was the summer and then fall of my junior year of school. I was in the midst of healing from a break up and recruiting for software engineering internships. If anyone knows anything about the software engineering recruiting season, it looks something like this: for half a year, you send in about a couple hundreds of applications, spend another hundred of hours on doing LeetCode (technical preparation platform), and hearing back from less than a handful of companies, most of which are companies telling you that they’ve rejected you. Every day, I was risking a little bit of my confidence for some success. A particularly bad experience was when I was flown out to San Francisco by Salesforce for the Tech Equality Summit pre-recruitment program to interview for Salesforce’s summer internship program. This program made it so the interview was really easy and not competitive—everyone flown out was the first people they interviewed for the season, so everyone had an equal chance of getting in rather than fighting for limited spots on the roster. I thought I nailed the interview, as did most kids after their interviews because they were relatively straightfoward. Two weeks later, the rejection letter hit my mailbox. My heart dropped. There goes probably the easiest chance for me to get into “big tech.”",
    7: "By the end of August, I was in the negatives for confidence (clearly didn’t start off with much lol.) I had been applying since May and the failure from Salesforce had taken a huge toll on me, coupled with the fact that I didn’t feel quite as emotionally recovered from my break up as I thought I should have been. I readied myself for a disappointing recruitment season. Numbing myself from each rejection email, I listlessly applied to random job opportunities, obsessed over LeetCode and refining my resume, and chugged on. This was the mindset I dubbed “robot rachel”—I’ve been given instructions, and I execute them again, and again, regardless of how I feel about result. Yes, I had to give it a corny name like that to be able to impersonate that kind of mindset. It made it feel more like a game, or a part of me which I switched on or off, rather than what defined my whole.",
    ...
    9: "Again, I was saved with my first offer of the season: The Trade Desk. And I’m not being dramatic when I say “saved.” Getting an offer after months of stressing about recruiting genuinely feels like you’ve been saved. You can enjoy breathing again. Okay, maybe I am being really dramatic. What followed was a reinvigoration to apply, not with the desperation of getting whatever I could get, but to get what I wanted. And that kind of recruiting is always fun. I ended up accepting an offer to go work at LinkedIn over the summer and then following that, Google in the fall.",
    10: "Then, thanks to my restless, anxious mind, I think to myself: “Well, I have confidence now. I can’t imagine feeling as bad as I did at my lowest points.” And now I’m scared—I don’t want to try any big things in case I lose all my confidence points I’ve gained so far. And college and internships are hardly the place where you face big things where you can fail in life: I’m looking to apply for graduate school, fall in love with a girl, start a family, figure out how to do a backflip on a snowboard, publish a book, start a commune, etc. As one does. Not to mention maintain things I already have right now; to lose those things I have now would be particularly hurtful because it would feel like I’m going backwards in life, and that certainly would be expensive to my confidence. But, I need to continuously be okay with failure in order to achieve these things. I can’t be afraid of “hitting the bottom of my confidence wallet.” So clearly, my mindset towards failure is all wrong. Failure shouldn’t cost my confidence.",
    ...
    12: "I invite you to also think about these questions. Too often, I see people like myself cringe at embarrassment, shy away from the risk of failure, and become demotivated when they do face failure. It this what we should feel? It failure just one of those things where people go “well that’s just life”?",
    13: "I think to one of the most famous quotes on how to handle failure: “You miss 100% of the shots you don’t take.” I almost hate this quote, because I think about a boy who reads this and then proceeds to harass every girl he sees to date him, and keeps doing it rejection after rejection because probabilistically there’s someone who will say yes, regardless if it’s out of pity or not. Shoot your shot boy!—please don’t. But I know that’s not what the quote is encouraging. You are supposed to reflect and learn from each shot that you missed.",
