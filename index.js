const ruminationDictionary = {
  ...
  "MY VALUES SO FAR": {
    ...
    5: "For me, it’s important that “I do the most good I can” in my life. I will define what that means in the rest of my writings below:",
  ...
  "MY PROPOSAL ON HOW WE MIGHT DISCERN TRUTH IN THE AGE OF AI": {
    1: "The other day, I believed I watched a security camera footage of some rabbits jumping on a person’s trampoline in their background. There was no such footage. It was AI-generated.",
    2: "The comments below the video were flooded with people lamenting over the fact that they fell for AI and other people asking how we knew it was AI. One apt watcher pointed out that one rabbit had blended seamlessly into the one next to it when they were jumping together. Given the subtly of the mistake, and the nature of TikToks being consumed within seconds, it was no surprise that many people fell for it.",
    3: "However, with Nano Banana 2 entering the game of video and image generation, mistakes like these are becoming harder and harder to spot. Some videos are completely realistic, with only social and historical context clues coming into play to deny the possibility of the video or image.",
    4: "And AI-generated content WILL reach the ability to replicate the real world to an extraordinary level of precision—tenfolds beyond our current status. This is because 1) we’ve already seen how much money AI can make and save for an economy, which is a primary driver for innovation whether we like the consequences or not and 2) the smartest people are fascinated on working on this problem. Turing award winner and one of the three “Godfathers of AI”, Yann LeCun, just started his own startup to develop “World Models” to teach AI using spatial models of the real world so it can interface and understand our reality better.",
    5: "Given this, the probably obvious question comes to mind: As AI-generated content progresses in it’s ability to replicate the real world, how might we capture and broadcast reality as it truly occurs?",
    6: "I first thought of what many are focused on: Given AI content, can you discern with high probability it is AI-generated? The most common example of this is GPTZero. But, a research paper called Can AI‑Generated Text be Reliably Detected? (2023) showed that these detectors often misclassify human-written text and are unreliable tools. And intuitively, these tools are probably always going to be one step behind because AI models are a moving target and are always trying to evade detection. It’s not a convincing possible solution.",
    7: "If we can’t discern between reality or AI once content has already been created, we will need to look to control things earlier in the creation of such content. There are watermarks like from Sora, but you can sometimes pay to remove the watermarks—and this idea of “someone can always just put their content in Adobe and remove any trace of any tag saying their content is AI” is one that shows just how hard this problem is.",
    8: "My proposal, or prediction rather, is that we will need to build an end-to-end content creation tool specifically to document reality without AI.",
    9: "First, there will be a tamper-resistant device to capture content (tamper-resistant execution environment exists such as Yubikeys, though I’m not sure if you can extend it to a whole camera). The invariant we want to uphold is that all the content that the end user sees has been captured only by these devices. The device will be provisioned by the company and it will have a private key so that even the device owner cannot extract it and use it elsewhere. This device will be able to take pictures and video. Each pixel is signed by the private key, saying that it has been taken by the provisioned device only.",
    10: "Second, there will be an editing software living on the cloud and providing most tools but reality-altering edits. It will accept image and video data only if the content has been signed by a provisioned device. It will keep track of every change made on a write-only ledger (blockchain) that could be made public if the public wants transparency on how the original content has been tampered with. There are two big invariants here we must uphold: 1) the content we receive in this software has not been tampered by another software and 2) the content the user ends up publishing came straight from this software.",
    11: "Number two is easy to prove. There could be a publishing website also upheld by the company that holds the “end product,” and once the user is done in the editing software, it publishes straight from the editing software and uses some share link to publish it to the rest of the world. The rest of the world trusts the company (I’ll get to how the world can trust the company), and thus can see the true footage themselves on this website. ",
    12: "Number one could be trickier. We need a way to securely transfer the original content from the device to the cloud software such that no one could ever capture the original content, not even the person who captured it. This is a problem of network security. ",
    13: "How might this tool come about and why should the public trust in this tool? A company will start it, heavily backed by government incentives to cut through the AI slop that is and will continue to degenerate the fabrics of political discourse and democracy. Naturally, people will and should distrust any single entity serving as arbiter of truth. Thus, along with this technology comes the requirement of great transparency. The company will likely want to start publishing transparency papers and reveal their complete technology in some fashion similar to open-source in the way Signal does. They should publish regular audits and allow independent researchers and hackers to probe their technology for weaknesses. Ideally, this  iteration process creates some public, mathematical/cryptographic proof to assure the safety and validity of the technology.",
    14: "In other words, the ideal environment for this truth-bearing technology to come about is in one which is entirely trustless.",
    15: "There is surely technical problems, exploits, misuse, etc. to this solution. But I could really see this being a viable solution such that when the generation that has this kind of technology comes across a damning video, they can go check the origins of the video from this company and be assured whether its fake or real.",
    16: "There are so many interesting technicalities here to explore; how to create the device, how to build trust with the public, how to meaningfully work with the government on this, and how to maintain an end-to-end tamper-resistant process. And I believe that the future that requires this kind of technology is closer than we think. Stay tuned for more content exploring these concepts.",
  },
  "PHILOSOPHY NEEDS TO BE A MANDATORY SUBJECT": {
    1: "As the final, bittersweet month of college approaches, I feel called to reflect on what this education meant to me. Some questions that come to mind are: <ul><li>Who am I now, with the knowledge and skills acquired?</li><li>Am I prepared to be a good and effective citizen, worker, friend?</li></ul> It is then I realize that if the answers to these questions are unsatisfactory, then perhaps education has failed. Thankfully, my answers are pretty satisfactory. A success in my eyes.",
    2: "Now, a big part of why was my time in college. It was transformative for me. As college does, I was granted a great level of autonomy all at once, faced extraordinary challenges—both mental and physical—and found loving communities where I was incubated, matured and came out having a lot of fun. Within all of this, I pursued a combined major in Computer Science and Philosophy.",
    3: "Pursuing this major alone was a big part of what made education work for me. Computer Science is my 'practical passion'—something that can make me a valuable producer in society (though, maybe not anymore after AI is done self-mutilating its mother-industry) and help financially sustain my needs. As for the Philosophy side of my major, it is not immediately as clear in the practical sense that it makes me a valuable producer. However, it is the thing that has become foundational to nearly every other aspect of being a good and effective citizen, friend and person. Without it, I would feel a lot less confident in being those things.",
    4: "I feel so strongly about this that I would like to put forth this claim: Philosophy should be a mandatory subject for all education.",
    5: "For the sake of brevity, I didn't specify what part of philosophy. Though, it makes a big difference what kind I mean. I will carve out the following: <ul><li><strong>Logic:</strong> How to determine and create valid inference</li><li><strong>Moral Theory:</strong> Metaphysics of morality, normative ethics (what is good and bad?), and some practical ethics of personal choice (medical ethics, business ethics, environmental ethics, tech ethics, social ethics and political ethics)</li><li><strong>Some selection of:</strong><ul><li>Political philosophy</li><li>Philosophy of economics</li><li>Indigenous or eastern philosophy</li><li>Epistemology (philosophy of knowledge)</li></ul></li></ul>",
    6: "So, not: the history of philosophical thought (e.g. doing big interpretative work into Plato, Kant, Nietzsche, etc.). While it is helpful to go through the great thinkers' lines of reasoning—and their works will certainly appear in the other forms of philosophy I mandate—it is not necessary. What I'm arguing is that philosophy develops foundational critical thinking skills and rationality, not that philosophy is a ball of knowledge to obtain.",
    7: "To support my claim, I will give a little tour of each subject. For something to be necessary for the education of all people, it should sufficiently allow for an individual to answer the two questions posed above in a satisfactory way. There is no 'hard' evidence or formal lines of reasoning as might be required for a school board. The purpose of this is more so to plant a reasonable idea in people's heads.",
    8: "First, let's start with logic. We use and hear the term 'logic' everywhere, particularly in places where people are trying to prove a claim like in politics. People use this term liberally in arguments: 'You're not being logical!' This is technically a very grave claim—more grave than people think—to make against your opponent in an argument. It means your opponent's argument could never be 'valid,' not even if all your claims are true. Take this example: All humans are mammals and Socrates is a man. Therefore, Paris is the capital of France. This argument is not logical because the conclusion does not follow from the premises. So even given all of these statements happen to be true, the argument is not valid and you're not bound by logic to believe the conclusion from this argument alone. That's powerful.",
    9: "When studying logic, you will learn how to decipher arguments with mathematical precision. It's the systematic investigation of the principles and application of valid reasoning, and its relations to their conclusions. Take this argument: <ol><li>If I'm wet, then it's raining</li><li>It's raining</li><li>Conclusion: I'm wet</li></ol> Do you think this is valid? At first glance, you might think yes—but this is NOT valid. The first statement does not mean that every time it's raining, I'm wet. It just means that if I am wet, then it's raining. People without any education in formal logic or argumentation building would be far more vulnerable to invalid arguments like this.",
    10: "Let's do another exercise—to not only show you how useful the study of logic is, but also to demonstrate that my own argument is valid and sensible. Define: <blockquote>G(x): x is a good system of mandatory education<br>P(x): x includes philosophy<br>A(x): x adequately prepares students to answer 'Who am I?' and 'Am I prepared to be a good and effective citizen, worker, and friend?'</blockquote> The premises follow as: <ol><li>All good mandatory education systems are systems that adequately prepare students to answer the key life and civic questions. &forall;x (G(x) &rightarrow; A(x))</li><li>All systems that adequately prepare students to answer the key questions are systems that include philosophy. &forall;x (A(x) &rightarrow; P(x))</li></ol> Conclusion: Therefore, all good mandatory education systems include philosophy. &forall;x (G(x) &rightarrow; P(x))",
    11: "Almost immediately, you can see why studying logic is imperative for being a well-functioning human being. We are social beings that rely on one another to make good politics, share goods and services, etc. We are always making claims where we want to be believed valid (me to you right now!). Understanding how we can do this clearly and without paradox means we can make better judgements on other people's claims and make claims that are adopted by others. Think about how important it is within friendship-building, democracy, professional settings—we are always in a tug and pull with people around us, in conversations that invoke our rationality to make good decisions. There are too many pitfalls to argumentation that slow this down: hasty generalizations, straw man attacks, ad hominem, correlation vs. causation. Logic is necessary to sustain foundational structures of common life from these falsities.",
    12: "Second, let's go to Moral Theory. I like to think of Moral Theory as the fire in which people live their lives. Without it, there is but a shell of the mechanics of a person—like a tool without a user. Everyone has their own moral theory—maybe flawed or not yet realized—deep down. It's the values we live by which influence what we think are good or bad choices. Maybe you don't believe in moral good or bad. But even that is a value that influences significant decisions and determines your character.",
    13: "I think it's through Moral Theory that people are able to challenge and determine good, long-lasting values for their lives. These values protect us from feeling non-human, from slaving away at goals that don't actually fulfill us, from being merely a tool others interact with. They help determine what we want to do professionally and outside our professional life, how we treat other people and what politics to subscribe to. Many of my peers and I personally have often struggled with feeling 'lost,' 'uninspired,' and 'not sure what I'm doing with my life.' These questions and feelings are ones that every human with the luxury to think such things will come back to time and time again. These are questions grappled by Moral Theory. I see it as a secular religion open to all.",
    14: "After Moral Theory, I've also included some of the following: <ul><li><strong>Political philosophy:</strong> What do we owe each other as members of society? A theory fundamental to being a good, effective voting citizen.</li><li><strong>Philosophy of economics:</strong> What is rationality/rational choice? Welfare economics and the building of a society. Also fundamental to being a good, effective voting citizen and understanding what makes a decision rational.</li><li><strong>Indigenous or eastern philosophy:</strong> To balance the overwhelming representation of western philosophy with one rooted in relationships, responsibility and dignity of nature, spirituality frameworks, etc.</li><li><strong>Epistemology (philosophy of knowledge):</strong> Knowledge vs. belief, as well as the ethics of belief (intellectual humility). Good inward practice of understanding where our knowledge comes from.</li></ul> I could imagine logic and moral theory being their own classes, and these being mere chapters within some broader philosophy class.",
    15: "I am not arguing that everyone who studies philosophy will leave transformed, or that a mandatory class will fix the many failures of modern education. But I do think there is something lost when people move through their entire formal education without ever being asked: <em>What makes a good argument? What do I actually believe is right, and why? What do I owe the people around me?</em> These are not luxury questions. They are the foundation of a life—and a society—worth living in. This is the case I want to leave you with.",
  },
  // "A HISTORY OF MY OBSESSIONS": {
  //   1: "During an interview for a position at a start-up, I was asked “whats makes you ready for what a startup demands?” And I think to answer this question, we must look at what a start up is, and what is the fuel to that process. Start-ups are the process of starting something new and putting in the time that is required for incubating a new born idea. This part of putting together singe cells into a zygote into a child is fueled by largely by obsession. Obsession. An idea or thought that continually preoccupies or intrudes on a person's mind. For it is only in the obsessive mind does work becomes play, a necessity, the end-all-be-all, all at once.",
  //   2: "It got me thinking about some of my own obsessions—and also how I view putting in hard work. In Silicon Valley, we’re beginning to see a rise of 9-9-6: Working from 9am to 9pm for 6 days a week. It’s not necessarily that you’re in the office those times; Someone put the 9-9-6 experience aptly as such: It’s about being in the working mind from those hours, and shortening many other aspects of your life (like uber-eating foods, taking meetings at the gym, etc.) such that you can maximize those hours.",
  //   3: "I, and many others, immediately scoff at such a work-life balance. Work shouldn’t take up your life! It’s not what is beautiful about living. But then I think about the times in which I put in my own kinds of 9-9-6s—and how when I did those hours, it didn’t feel like “work”. It was purpose. It was the beautiful life.",
  //   4: "So let’s take a little tour of my 9-9-6s. Not just any of them, but the most fun ones. These were things that I thought about nearly every waking moment for at least a month straight. Any less (e.g. soccer, working out, food) is ruled out from this list.",
  //   5: "ONE: World-building",
  //   6: "From ages 10 to 17, I made all sorts of stories. It started from mimicking the world of Warrior Cats—creating my own characters and plots in the pre-existing world—to creating vast new worlds, with different cultures, environments, politics, socio-economic levels, and powers.",
  //   7: "In my Drive, I just counted about 40 documents and about the same on my Notion. Each of the documents would either be a character / world study or an unfinished story. My most recent story was about an immortal named Sennacherib that regrettably made a woman immortal, and the consequences of making a mortal woman live forever. It was centered around a monastery in Germany whose architecture I based off of the Hohenzollern Castle. And this is why I say “world-building” was my obsession—NOT writing. Because I totally fell in love with making the world. Here’s an example of the floor plan I set up.",
  //   8: "project_images/obsessions/floorplan.png",
  //   9: "Learning how to create a convincing world meant that I had to learn about how the world works: What kinds of agriculture grows on what kinds of land?; How does one occupation changes the way they act in their communities?; How do different cultures form? My passion for world building and stories was one of the biggest influences for my intellectual curiosity and more. ",
  //   10: "I will publish my own book one day. ",
  //   11: "TWO: AP US History",
  //   12: "Yes, you unfortunately read that right. I was obsessed with APUSH.",
  //   13: "Only retrospectively did I realize I quite literally spent 9-9-6 on APUSH. It was because I became fixated on completing a foolproof wiki on every single event ever that would be covered in APUSH.",
  //   14: "Here is the website: https://rachelsworks.notion.site/AP-US-HISTORY-cf6b1600d6b14bc9a26f7c062c83862e?pvs=74",
  //   15: "My magnum opus, over 43,000 words. To put that into something meaningful, that is 172 pages if it were to be put into a book. What the hell was I on? But hey, even to this day, it still gets a couple views every day. ",
  //   16: "This was partnered (as if I needed more APUSH in my life during those months) with me becoming a (this is embarrassing, please stay with me now) discord moderator for Mr. Heimler, a YouTuber famous for his videos explaining APUSH topics. His discord at the time had around 25,000 users, of whom I would monitor to uphold his community rules and also provide APUSH help to. I accumulated a couple of thousands of messages on that Discord server.",
  //   17: "Safe to say, I got a 5 on that AP exam.",
  //   18: "THREE: Minecraft Baltop",
  //   19: "Welcome, quarantine time obsession. Unsurprisingly, there is a game in the mix. Thankfully, it wasn’t Valorant or League.",
  //   20: "Minecraft Baltop was a particular game style in which I joined a small server, about 30 - 50 players at a time, where we would all compete to get the highest amount of money at the end of the month. You could get money by selling to an in-game universal “shop” that had unlimited money to give if you have the resources to sell.",
  //   21: "To optimize getting money, you would select some high paying resources and create automatic farms to generate that resource to sell. There were a lot of actual complicated game mechanics and strategies that you have to learn in order to maximize these automatic farms. I played with these people from Britain, so I’d wake up early like 7am - 8am to play with them, or stay up really late. We built massive, massive farms together and placed in the top 3 by the end of the month, winning an astonishing $25 of real life money. Wow, so worth it.",
  //   22: "This lowkey changed the course of my life. Because I was playing Minecraft so much, I didn’t study too well for AP Biology, and got a 3 on the exam. It was from this exam when I decided I wouldn’t be cut out to become a doctor. Now I’m neck deep in the tech world. Look, I’m sure all this time spent optimizing farms has some relation to software engineering.",
  //   23: "FOUR: Truth Agent",
  //   24: "Imagine yourself, summer 2024. The past two years being full of politic turmoil, with BLM, the Trump vs. Harris campaign, Israel-Palestine conflict reigniting on the world stage with college campuses being one of the main actors on the other side of the camera. Invigorated, frustrated, and inspired to act, I knew that one of the most important things during times like these is learning the full picture; the truth. To be able to strip the chaos into what it is.",
  //   25: "This was the motivation behind a project I called the Truth Agent or Veritas. It was going to be a browser extension agent that would read over your shoulder, and highlight things on the website that they believed were manipulative or misinformation, and helped define or provide context to certain words or events.",
  //   26: "I would work on this the moment I got home from my internship. I ended up submitting this project to a Google Gemini Developer contest. I didn’t win anything, but I’m hoping to return to this project soon, and launch it. It’s a product I need in my life, in this digital age.",
  // },
};
...
const ruminationSidenotes = {
  ...
  "PHILOSOPHY NEEDS TO BE A MANDATORY SUBJECT": {
    10: "G(x), P(x), and A(x) are predicates — functions that take an x and return true or false. &forall;x ('for all x') is a universal quantifier, meaning the statement holds for every possible x, not just a specific one.",
  },
  // "A HISTORY OF MY OBSESSIONS": {},
};
      ...
      if (
        ...
        return `
          <div class="paragraph-wrapper">
            ...
            <div class="rumination-paragraph">${content}</div>
            ${index % 2 !== 0 ? sidenoteHTML : ""}
          </div>`;
      }
    })
...
function renderRuminationContent(paragraphs, sidenotes = {}) {
  return Object.entries(paragraphs)
    .map(([index, text]) => {
      ...
      if (
        typeof text === "string" &&
        text.match(/\.(jpeg|jpg|png|gif|webp)$/)
      ) {
        return `
          <div class="technical-image-container">
            <img class="technical-image" src="${text}" alt="Rumination image" />
          </div>`;
      } else {
        return `
          <div class="paragraph-wrapper">
            ${index % 2 === 0 ? sidenoteHTML : ""}
            <div class="rumination-paragraph">${text}</div>
            ${index % 2 !== 0 ? sidenoteHTML : ""}
          </div>`;
      }
    })
  ...
  document.querySelectorAll(".rumination-box").forEach((box) => {
    box.addEventListener("click", async () => {
      ...
      if (!paragraphs) {
        ...
        readerBody.innerHTML = renderRuminationContent(paragraphs, sidenotes);
      }
